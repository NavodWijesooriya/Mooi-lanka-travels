...
import Logo from '../../../../public/assets/mooiLanka-logo-3.png';
...
const Navbar = () => {
      ...
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow-lg transition-transform transform origin-top duration-200 ease-in-out">
            ...
            <li><Link href='/addBlog'>BLOG</Link></li>

          </ul>
        </div>
        <Link href='/' className={`${styles.logoLink} ml-4`}>
  <Image
    className={`${styles.logo} transition-all duration-300 ease-in-out ${isVisible ? 'h-48 w-auto' : 'h-36 w-auto'}`}
    src={Logo}
  ...
  />
        ...
        <ul className="menu menu-horizontal px-1 text-white font-semibold">
          ...
          <li className={styles.menuItem}><Link href='https://travel-agency-e3ob.vercel.app/blog' target='_blank'>BLOG</Link></li>
        </ul>
      </div>
